...
def month_start() -> str:
    return datetime.now(COLOMBIA_TZ).replace(day=1).strftime("%Y-%m-%d")
...
async def list_tools() -> list[types.Tool]:
    return [
        ...
        types.Tool(
            ...
            description="Métricas de TODAS las campañas activas de REMA: registros completados, costo por registro, gasto, impresiones, CTR y frecuencia.",
            inputSchema={
                "type": "object",
                "properties": {
    ...
    if name == "get_campaigns":
        ...
        for c in data.get("data", []):
            out.append({
                ...
                "leads":         get_action(c.get("actions", []), "complete_registration"),
                "cpl":           get_cpa(c.get("cost_per_action_type", []), "complete_registration"),
            })
        ...
        result = {
            ...
            "leads":         get_action(r.get("actions", []), "complete_registration"),
            "cpl":           get_cpa(r.get("cost_per_action_type", []), "complete_registration"),
        ...
        for ad in data.get("data", []):
            ...
            out.append({
                ...
                "ctr":        ad.get("ctr"),
                "reach":      ad.get("reach"),
                "leads":      get_action(ad.get("actions", []), "complete_registration"),
                "cpl":        get_cpa(ad.get("cost_per_action_type", []), "complete_registration"),
